...
describe('Note API:', function() {
  ...
  describe('POST /api/notes', function() {
    beforeEach(function(done) {
      request(app)
        ...
        .send({
          title: 'New Note',
          content: 'This is the brand new note!!!'
        })
        .expect(201)
        .expect('Content-Type', /json/)
        .end((err, res) => {
    ...
    it('should respond with the newly created note', function() {
      newNote.title.should.equal('New Note');
      newNote.content.should.equal('This is the brand new note!!!');
    });
  ...
  describe('GET /api/notes/:id', function() {
    ...
    it('should respond with the requested note', function() {
      note.title.should.equal('New Note');
      note.content.should.equal('This is the brand new note!!!');
    });
  ...
  describe('PUT /api/notes/:id', function() {
    ...
    it('should respond with the updated note', function() {
      updatedNote.title.should.equal('Updated Note');
      updatedNote.content.should.equal('This is the updated note!!!');
    });
